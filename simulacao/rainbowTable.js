...
const senhasComuns = ["senha", "123456", "senha123", "admin","senha123456",
"1234", "blink182","meuAniversario", "senha123456", "brasil", "102030"]
...
const senhaEncontrada = hashesVazadas.map( hash => {
    const senha = rainbowTable.find( senha => senha[1] === hash)
    return senha ? senha[0] : null
})

console.log(senhaEncontrada)